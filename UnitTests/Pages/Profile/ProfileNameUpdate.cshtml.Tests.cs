...
namespace UnitTests.Pages.Product.Update
{
    ...
    public class ProfileNameUpdateTests
    {
        ...
        // Initialize ProfileNameUpdateModel with TestHelper
        [SetUp]
        ...
        #region OnPostAsync
        // Test to verify OnPost updating profile name with valid values keeps valid model state
        [Test]
        ...
        [Test]
        // Test to verify OnPost updating profile name with invalid values returns invalid model state
